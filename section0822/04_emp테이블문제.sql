...
select ename, hiredate, deptno from emp order by deptno, hiredate; -- asc생략가능
...
select ename 이름, job 직급, sal 급여 --as 생략가능
...
select ename, hiredate, to_char(hiredate, 'YYYY-MM-DD') as 입사일, deptno
from emp
...
from emp
group by to_char(hiredate, 'mm')
order by 인원수 desc;  --order by count(*) desc 와 같은 결과
...
select deptno
     ...
     , round(avg(sal+nvl(comm, 0)), 0) 평균값
from emp
group by deptno
order by deptno;
////////////////////////////////////////////////////////////////////////////////
